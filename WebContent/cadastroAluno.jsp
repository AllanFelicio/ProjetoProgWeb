	...
	<body>
		<div id="Tudo">
			...
			<div id="Conteudo">
				...
				<form action="ControleServelet" method="Cadastrar" onsubmit="return confimaSenhaSenha(this)">
					<div align="center">
						<h1 class="cad_usuario">Cadastro de Usuário</h1>
					</div>
					<br>
					<div id="Conteudo">
						<label>
							<span>Matricula: </span>
							<input id="matricula" type="text" name="matricula" placeholder="Até 10 Caracteres" maxlength="10" required >
						</label>
						<label>
							<span>Nome: </span>
							<input id="nome" type="text" name="nome" placeholder="Até 40 Caracteres" onkeyup="validar(this,'text');" size="40" maxlength="40" required >
						</label>
						<label>
							<span>RG: </span>
							<input id="rg" type="text" name="rg" placeholder="Até 7 Caracteres" onkeypress="mascara(this, '####-###')" onKeyUp="javascript:numero(this);" size="40" maxlength="8" required >
						</label>
						<label>
							<span>CPF: </span>
							<input id="cpf" type="text" name="cpf" placeholder="Até 11 Caracteres" onKeyUp="javascript:numero(this);" onkeypress="mascara(this, '#########-##')" size="40" maxlength="12" required >
						</label>
						<label>
							<span>E-Mail </span>
							<input id="email" type="email" name="email" placeholder="Digite seu E-mail" size="40" maxlength="40" required>
						</label>
						<label>
							<span name="sexo">Sexo: </span>
						...
						<label>
							<span>Nível de escolariedade </span>
								<select id="escolariedade" name="escolariedade" style="font-size:12px;">
							...
							<label>
								<span>Curso</span>
								<select  id ="area_sup" name="curso" style="font-size:12px;">
									<option>Administração</option>
									<option>Ciências contabéis</option>
						...
						<label>
							<span name="turno">Escolha o turno:</span>
								<input type="checkbox" name="manhã"> Manhã 
						...
						<label>
							<span>Senha: </span>
							<input id="senha" type="password" name="senha" minlength='8' maxlength='15' placeholder='Até 8 Digitos' required>
						</label>
						<label>
							...
							<label>
							<input type="submit" value="Salvar Alterações" class="btm_cad" onclick="confirmaSenha()">
